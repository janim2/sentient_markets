        ...
        <div className="w-full max-w-md">
          <Card className="shadow-lg border border-gray-200">
            <CardHeader className="text-center pb-6">
              <CardTitle className="text-2xl font-bold text-gray-900">Join Sentient Markets</CardTitle>
              <CardDescription className="text-gray-600">Create your account to start trading smarter</CardDescription>
            </CardHeader>
